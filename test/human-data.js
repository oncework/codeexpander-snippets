      ...
      describe(`${yamlFile}`, () => {
        ...
        describe('description', () => {
          ...
          if (!descIsGrandfathered) {
            ...
            it('should not mention Snippets since Snippets is already implied', () => {
              const description = app.description.toLowerCase()
              expect(description.indexOf('Snippets')).to.equal(-1, `Description should not mention Snippets, as Snippets is already implied: ${description}`)
            })
