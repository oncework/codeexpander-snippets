...
behavior to xudaolong@gmail.com.

The following is a set of guidelines for contributing to `codeexpander-snippets`.
...
If you have an snippets you'd like to see added, please
...
```sh
git clone https://github.com/oncework/codeexpander-snippets
cd codeexpander-snippets
...
Once your pull request has been merged, your changes will automatically be published in a new release of the `codeexpander-snippets` npm module. This process
